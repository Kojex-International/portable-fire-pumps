        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              name="firstName"
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] transition"
            />
          </div>
          <div>
            <Label.Root
          ...
          <div>
            ...
            <input
              ...
              className="peer w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] invalid:border-rose-300 focus:invalid:border-rose-400 placeholder-shown:invalid:border-gray-300 transition"
            />
          ...
          <div>
            ...
            <input
              ...
              className="peer w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] invalid:border-rose-300 focus:invalid:border-rose-400 transition"
            />
            <p className={`mt-1 text-xs text-rose-600 ${showValidationErrors ? 'hidden peer-invalid:block peer-placeholder-shown:hidden' : 'hidden'}`}>
              {t.phoneInvalid}
            </p>
        ...
        <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  id="timeline"
                  name="timeline"
                  className="w-full px-4 py-2 pl-10 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] transition appearance-none bg-white"
                >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 pl-10 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] transition"
                />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:border-[var(--brand-200)] transition resize-none"
            />
          </div>
        </div>
      </div>
