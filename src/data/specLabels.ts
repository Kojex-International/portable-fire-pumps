...
export const SPEC_LABELS = {
  ...
  maximumDischargePerformance: { en: 'Maximum Discharge Performance', fr: 'Performance maximale de refoulement' },
...
const SPEC_LABEL_ALIASES: Record<string, SpecKey> = {
  ...
  'Maximum Discharge Performance': 'maximumDischargePerformance',
  'Performance maximale de refoulement': 'maximumDischargePerformance',
