...
const frReplacements: Array<[string, string]> = [
  ["Strong power with Shibaura's original air-cooled engine", "Grande puissance avec le moteur Shibaura original refroidi à l'air"],
  ["Shibaura's largest air-cooled engine delivers strong power without influencing water quality.", "Le plus grand moteur Shibaura refroidi à l'air offre une puissance élevée sans compromettre la qualité de l'eau."],
  ['Big-bore air-cooled performance with fast starting and quick valve control for demanding field use.', "Performances à gros alésage avec refroidissement à l'air, démarrage rapide et contrôle de vanne immédiat pour les interventions exigeantes."],
  ['Compact and light weight', 'Compacte et légère'],
  ['A compact, lightweight pump delivering class-leading performance. The newly installed 5.3 L fuel tank supports extended operating time.', "Pompe compacte et légère offrant des performances de premier plan. Le réservoir de 5,3 L assure une autonomie prolongée."],
  ...
  ['The smallest pump in its class, offering superior mobility', 'La plus petite pompe de sa catégorie, offrant une mobilité supérieure'],
  ["Its compact, lightweight design with Shibaura's proprietary air-cooled engine allows for simple installation on small vehicles.", "Son format compact et léger, avec le moteur Shibaura exclusif refroidi à l'air, permet une installation simple sur les petits véhicules."],
  ...
  ['Highest discharge performance of our lineup', 'Performance de refoulement la plus élevée de la gamme'],
  ['Delivers the highest discharge performance. A large oil-less vacuum pump combined with a high-output engine enables faster priming and a greater volume of water discharge within its class.', "Offre la meilleure performance de refoulement de la gamme. Une grande pompe à vide sans huile, combinée à un moteur haute puissance, permet un amorçage plus rapide et un volume de refoulement supérieur dans sa catégorie."],
  ['High-output fire pump built for demanding operations and rapid priming.', "Pompe à incendie haute performance conçue pour les opérations exigeantes et l'amorçage rapide."],
  ['Durable, well-balanced performance', 'Performance durable et bien équilibrée'],
  ["A well-balanced, durable pump featuring Shibaura's proprietary engine-cooling system. The fully water-cooled radiator ensures reliable operation and extended service life, even in dirty-water environments.", "Pompe durable et bien équilibrée, équipée du système de refroidissement moteur exclusif Shibaura. Le radiateur entièrement refroidi à l'eau assure un fonctionnement fiable et une longue durée de vie, même en eau chargée."],
  ...
  ['Enables long-distance water delivery by automatically relaying flow between pumps without operator intervention. Electronic fuel injection ensures easy starting and efficient fuel consumption.', "Permet l'acheminement d'eau sur longue distance grâce au relais automatique du débit entre les pompes, sans intervention de l'opérateur. L'injection électronique de carburant assure un démarrage facile et une consommation maîtrisée."],
  ['Auto-relay pump for long-distance water delivery and efficient operations.', "Pompe auto-relais pour l'acheminement d'eau longue distance et des opérations efficaces."],
  ...
  ['Fuel tank supports longer operation windows.', "Le réservoir permet une durée d'utilisation plus longue."],
  ...
  ['Electronic injection for easier starting and efficiency.', "L'injection électronique facilite le démarrage et améliore l'efficacité."],
  ['1,550 L/min at 0.5 MPa for sustained flow.', '1 550 L/min à 0,5 MPa pour un débit soutenu.'],
  ['High-Performance', 'Haute performance'],
  ['Portable Fire Pumps', 'Pompes à incendie portatives'],
  ['Air-cooled', "Refroidi à l'air"],
  ['Water-cooled', "Refroidi à l'eau"],
  ['air-cooled', "refroidi à l'air"],
  ['water-cooled', "refroidi à l'eau"],
  ['Cooling system', 'Système de refroidissement'],
  ['Discharge performance', 'Performance de refoulement'],
  ['Priming performance', "Performance d'amorçage"],
  ...
  ['Blade type', 'Type de palette'],
  ['Maximum suction height', "Hauteur d'aspiration maximale"],
  ['Features', 'Caractéristiques'],
  ['Yes', 'Oui'],
  ['Seconds', 'secondes'],
  ['suction head', "hauteur d'aspiration"],
  ...
  ['Air cooled type', "type refroidi à l'air"],
  ['Water cooled type', "type refroidi à l'eau"],
